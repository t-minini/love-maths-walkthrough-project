...
function checkAnswer() {
  ...
  if (isCorrect) {
    ...
    alert(
      `Awwwwwww... you answered ${userAnswer}. The correct answer was ${calculatedAnswer[0]}`
    );
...
function displaySubtractionQuestion(operand1, operand2) {
  document.getElementById('operand1').textContent =
    operand1 > operand2 ? operand1 : operand2; // to avoid operand2 being grater than operand1
  document.getElementById('operand2').textContent =
    operand1 > operand2 ? operand2 : operand1; // to avoid operand2 being grater than operand1
  document.getElementById('operator').textContent = '-';
}
